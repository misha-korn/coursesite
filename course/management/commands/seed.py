...
COURSES = [
            (
                ...
                "3490.00",
                [("Что такое компонент", 15), ("Состояние и хуки", 25),
                 ("Роутинг", 20), ("Работа с API", 30)],
            ),
            (
                "databases",
                ...
                "3990.00",
                [("Модель данных", 20), ("Индексы и EXPLAIN", 35),
                 ("Транзакции", 30), ("Блокировки и дедлоки", 25)],
            ),
            (
                "devops",
                ...
                "3690.00",
                [("Образы и контейнеры", 25), ("docker compose", 30),
                 ("GitHub Actions", 30), ("Деплой на VPS", 25)],
            ),
            (
                "data-analytics",
                "SQL для аналитика",
                ...
                "2490.00",
                [("SELECT и фильтры", 20), ("JOIN и агрегация", 30),
                 ("Оконные функции", 35)],
            ),
            (
                "ux-ui-design",
                ...
                "3290.00",
                [("Исследование пользователей", 25), ("Прототипирование", 30),
                 ("Дизайн-система", 25)],
            ),
            (
                "mobile-development",
                ...
                "4290.00",
                [("Виджеты и вёрстка", 20), ("Навигация", 20),
                 ("Состояние приложения", 30), ("Публикация в сторы", 15)],
            ),
            (
                "testing",
                ...
                "2890.00",
                [("Первый тест", 15), ("Фикстуры", 25),
                 ("Моки и заглушки", 30), ("Покрытие и CI", 20)],
            ),
            (
                "machine-learning",
                ...
                "5490.00",
                [("Как учится модель", 25), ("Линейная регрессия", 30),
                 ("Классификация", 30), ("Переобучение", 20)],
            ),
            (
                "seo",
                ...
                "1990.00",
                [("Как работает поиск", 20), ("Семантическое ядро", 30),
            ...
            (
                ...
                "2290.00",
                [("Лексика разработчика", 20), ("Чтение документации", 25),
                 ("Переписка в команде", 20), ("Собеседование", 30)],
            ),
        ]
